...
AESEncryption::AESEncryption(int keyLen)
{
    this->Nb = 4;
...
unsigned char *AESEncryption::EncryptECB(unsigned char in[], unsigned int inLen, unsigned  char key[], unsigned int &outLen)
{
...
unsigned char *AESEncryption::DecryptECB(unsigned char in[], unsigned int inLen, unsigned  char key[])
{
...
unsigned char *AESEncryption::EncryptCBC(unsigned char in[], unsigned int inLen, unsigned  char key[], unsigned char *iv, unsigned int &outLen)
{
    outLen = GetPaddingLength(inLen);
...
unsigned char *AESEncryption::DecryptCBC(unsigned char in[], unsigned int inLen, unsigned  char key[], unsigned char * iv)
{
    unsigned char *out = new unsigned char[inLen];
    unsigned char *block = new unsigned char[blockBytesLen];
...
unsigned char *AESEncryption::EncryptCFB(unsigned char in[], unsigned int inLen, unsigned  char key[], unsigned char * iv, unsigned int &outLen)
{
    outLen = GetPaddingLength(inLen);
...
unsigned char *AESEncryption::DecryptCFB(unsigned char in[], unsigned int inLen, unsigned  char key[], unsigned char * iv)
{
    unsigned char *out = new unsigned char[inLen];
    unsigned char *block = new unsigned char[blockBytesLen];
    unsigned char *encryptedBlock = new unsigned char[blockBytesLen];
...
unsigned char *AESEncryption::PaddingNulls(unsigned char in[], unsigned int inLen, unsigned int alignLen)
{
...
unsigned int AESEncryption::GetPaddingLength(unsigned int len)
{
...
void AESEncryption::EncryptBlock(unsigned char in[], unsigned char out[], unsigned  char key[])
{
...
void AESEncryption::DecryptBlock(unsigned char in[], unsigned char out[], unsigned  char key[])
{
    unsigned char *w = new unsigned char[4 * Nb * (Nr + 1)];
...
void AESEncryption::SubBytes(unsigned char **state)
{
    int i, j;
    unsigned char t;
...
void AESEncryption::ShiftRow(unsigned char **state, int i, int n)    // shift row i on n positions
{
    unsigned char t;
    int k, j;
...
void AESEncryption::ShiftRows(unsigned char **state)
{
    ShiftRow(state, 1, 1);
    ShiftRow(state, 2, 2);
    ShiftRow(state, 3, 3);
...
unsigned char AESEncryption::xtime(unsigned char b)    // multiply on x
{
...
unsigned char AESEncryption::mul_bytes(unsigned char a, unsigned char b)
{
...
void AESEncryption::MixColumns(unsigned char **state)
{
...
void AESEncryption::KeyExpansion(unsigned char key[], unsigned char w[])
{
...
void AESEncryption::InvSubBytes(unsigned char **state)
{
    int i, j;
    unsigned char t;
    for (i = 0; i < 4; i++)
...
void AESEncryption::InvMixColumns(unsigned char **state)
{
    unsigned char s[4], s1[4];
    int i, j;
...
void AESEncryption::InvShiftRows(unsigned char **state)
{
...
void AESEncryption::XorBlocks(unsigned char *a, unsigned char * b, unsigned char *c, unsigned int len)
{
...
void AESEncryption::printHexArray (unsigned char a[], unsigned int n)
{
    for (int i = 0; i < n; i++)
    {
        printf("%02x ", a[i]);
